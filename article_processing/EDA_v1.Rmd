...
p1 <- plot_dat_1 %>% 
    ggplot(., aes(x = reorder(Embodiment, +count), y = count, fill = `Application Space`)) + geom_col() + 
    #theme_eai +       
    scale_fill_tableau() + 
...
p2 <- plot_dat_2 %>% 
    ggplot(., aes(x = reorder(`Measurement Method`, +count), y = count, fill = `Study Design`)) + geom_col() + 
    #theme_eai +       
    scale_fill_tableau() + 
    #ylab("Empathy Definiton Implemented") + 
    #scale_fill_manual(values=c("#BD8C58", "#597787")) +
...
p3 <- plot_dat_3 %>% 
    ggplot(., aes(x = reorder(`Empathy Domain`, +count), y = count, fill = Approach)) + geom_col() + 
    #theme_eai +       
    scale_fill_tableau() + 
    #ylab("Empathy Definiton Implemented") + 
    #scale_fill_manual(values=c("#BD8C58", "#597787")) +
...
p4 <- plot_dat_4 %>% 
    ggplot(., aes(x = reorder(def_imp, +count), y = count, fill = `Study design`)) + geom_col() + 
    #theme_eai +       
    scale_fill_tableau() + 
    theme_light() +
    #ylab("Empathy Definiton Implemented") + 
...
```{r}
figure = ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2, common.legend = F) + theme_light()
figure
```
