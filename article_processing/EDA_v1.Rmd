...
APP + geom_curve(
    ...
    color = "gray20", curvature = -0.3) +
      annotate("text", x = 3.6, y = 400, label = "Tomio Watanabe", size = 3) +
      annotate("text", x = 3.6, y = 300, label = "Hiroshi Ishiguro", size = 3) 
...
researcher_data1 %>% 
            summarise(mean(count_researchers))
```
